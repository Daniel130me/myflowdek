  ...
  return sendEmail({
    ...
    html: `
      <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto;">
        <h2 style="color: #C2410C;">Welcome to FlowDeck!</h2>
        <p>Please verify your email address by clicking the button below:</p>
        <p style="margin: 24px 0;">
          <a href="${link}" style="background: #C2410C; color: #fff; padding: 12px 24px; border-radius: 8px; text-decoration: none; display: inline-block;">Verify Email</a>
        </p>
  ...
  return sendEmail({
    ...
    html: `
      <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto;">
        ...
        <p style="margin: 24px 0;">
          <a href="${link}" style="background: #C2410C; color: #fff; padding: 12px 24px; border-radius: 8px; text-decoration: none; display: inline-block;">Reset Password</a>
        </p>
...
export async function sendInvitationEmail(
  ...
  return sendEmail({
    ...
    html: `
      <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto;">
        <h2 style="color: #C2410C;">You're invited to FlowDeck!</h2>
        <p>You've been invited to join <strong>${workspaceName}</strong> on FlowDeck.</p>
        <p style="margin: 24px 0;">
          <a href="${link}" style="background: #C2410C; color: #fff; padding: 12px 24px; border-radius: 8px; text-decoration: none; display: inline-block;">Accept Invitation</a>
        </p>
