...
import { EMAIL_FROM, EMAIL_FROM_NAME, EMAIL_BRAND_COLOR } from './constants';
  ...
  return sendEmail({
    ...
    html: `
      <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto;">
        <h2 style="color: ${EMAIL_BRAND_COLOR};">Welcome to FlowDeck!</h2>
        <p>Please verify your email address by clicking the button below:</p>
        <p style="margin: 24px 0;">
          <a href="${link}" style="background: ${EMAIL_BRAND_COLOR}; color: #fff; padding: 12px 24px; border-radius: 8px; text-decoration: none; display: inline-block;">Verify Email</a>
        </p>
...
export async function sendPasswordResetEmail(
  ...
  return sendEmail({
    ...
    html: `
      <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto;">
        <h2 style="color: ${EMAIL_BRAND_COLOR};">Reset your password</h2>
        <p>We received a request to reset your FlowDeck password.</p>
        <p style="margin: 24px 0;">
          <a href="${link}" style="background: ${EMAIL_BRAND_COLOR}; color: #fff; padding: 12px 24px; border-radius: 8px; text-decoration: none; display: inline-block;">Reset Password</a>
        </p>
...
export async function sendInvitationEmail(
  ...
  return sendEmail({
    ...
    html: `
      <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto;">
        <h2 style="color: ${EMAIL_BRAND_COLOR};">You're invited to FlowDeck!</h2>
        <p>You've been invited to join <strong>${workspaceName}</strong> on FlowDeck.</p>
        <p style="margin: 24px 0;">
          <a href="${link}" style="background: ${EMAIL_BRAND_COLOR}; color: #fff; padding: 12px 24px; border-radius: 8px; text-decoration: none; display: inline-block;">Accept Invitation</a>
        </p>
