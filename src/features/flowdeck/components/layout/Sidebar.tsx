...
export function Sidebar({ project, projects, activeView, onNavigate, goToPortfolio, pendingMyTasks = 0, onToggleFavorite, onArchive, onLogout, workspaces, selectedWorkspace, onSelectWorkspace }: {
  ...
  return (
    <aside style={{
      ...
      <div style={{ margin: '4px 20px 10px', borderTop: `1px solid ${S.divider}`, flexShrink: 0 }} />

      {project && (
        <div style={{ padding: '0 20px 10px', fontSize: 11, fontWeight: 600, color: S.textDim, textTransform: 'uppercase', letterSpacing: 0.8, display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
      ...
      <nav style={{
        ...
        {archivedProjects.length > 0 && (
          <div style={{ marginTop: 'auto', paddingTop: 8 }}>
            <div style={{ margin: '4px 8px 6px', borderTop: `1px solid ${S.divider}` }} />
            ...
            {showArchived && (
              <div style={{ padding: '2px 0 6px', display: 'flex', flexDirection: 'column', gap: 1 }}>
      ...
      <div style={{ padding: '16px 16px 20px', borderTop: `1px solid ${S.divider}`, flexShrink: 0 }}>
