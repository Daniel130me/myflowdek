...
ALTER TABLE File ADD CONSTRAINT File_storageConnectionId_fkey
FOREIGN KEY (storageConnectionId) REFERENCES StorageConnection(id) ON DELETE SET NULL ON UPDATE CASCADE;
